...
${OBJECTDIR}/lib/gpio/gpio.o: lib/gpio/gpio.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/gpio/gpio.o lib/gpio/gpio.cpp

${OBJECTDIR}/lib/RF24/compatibility.o: lib/RF24/compatibility.c 
	${MKDIR} -p ${OBJECTDIR}/lib/RF24
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/RF24/compatibility.o lib/RF24/compatibility.c

${OBJECTDIR}/lib/spi/spi.o: lib/spi/spi.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/spi
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/spi/spi.o lib/spi/spi.cpp

${OBJECTDIR}/lib/RF24/RF24.o: lib/RF24/RF24.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/RF24
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/RF24/RF24.o lib/RF24/RF24.cpp
